...
class Product:
    ...
    def __str__(self):
        return "Id {0}, Manufacturer: {1}, Type: {2}, Status: {3}, Cost: {4:.2f}, Service Date: {5}".format(self.__id, self.__manufacturer, self.__type, self.__status, self.__cost, self.__serviceDate)
